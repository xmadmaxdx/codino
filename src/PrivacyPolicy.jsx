        ...
        <div className="min-h-screen bg-bg-deep text-white font-sans selection:bg-primary/30">
            ...
            <main className="max-w-4xl mx-auto px-8 sm:px-20 pt-40 pb-20">
                ...
                <motion.p
                    ...
                    className="text-text-secondary/80 mb-16 font-normal max-w-2xl px-1"
                >
                ...
                <motion.div
                    ...
                    className="prose prose-invert prose-p:text-text-secondary prose-p:leading-relaxed prose-headings:text-white prose-headings:font-medium prose-headings:tracking-tight space-y-12"
                >
                    <section>
                        <p>
